...
export const testFixtureData: AppData = {
  storeProfiles: [
    {
      ...
      roomNames: ["护理房 1", "护理房 2", "VIP护理房", "仪器房", "身心护理房", "备用房"],
  ...
  authUsers: [
    ...
    { id: "u_owner", storeId: "store1", name: "林老板", account: "owner@test.local", password: "test-password", role: "owner", roleName: "老板", status: "active", createdAt: nowIso() },
    { id: "u_manager", storeId: "store1", name: "林主管", account: "manager@test.local", password: "test-password", role: "manager", roleName: "主管", staffId: "s1", status: "active", createdAt: nowIso() },
    { id: "u_frontdesk", storeId: "store1", name: "阿宁", account: "frontdesk@test.local", password: "test-password", role: "frontdesk", roleName: "前台", staffId: "s3", status: "active", createdAt: nowIso() },
    { id: "u_therapist", storeId: "store1", name: "小雅", account: "therapist@test.local", password: "test-password", role: "therapist", roleName: "员工", staffId: "s2", status: "active", createdAt: nowIso() },
    { id: "u_finance", storeId: "store1", name: "财务", account: "finance@test.local", password: "test-password", role: "finance", roleName: "财务", status: "active", createdAt: nowIso() },
  ],
  staffInvites: [],
  storeOwnerInvites: [],
  storeOwnerApplications: [],
  staff: [
    { id: "s1", storeId: "store1", name: "林主管", phone: "13800000001", role: "主管", status: "active", accountId: "u_manager", hiredAt: "2025-01-01", baseSalary: 9000, commissionRate: 0.12 },
    { id: "s2", storeId: "store1", name: "小雅", phone: "13800000002", role: "员工", status: "active", accountId: "u_therapist", hiredAt: "2025-03-01", baseSalary: 6500, commissionRate: 0.12 },
    { id: "s3", storeId: "store1", name: "阿宁", phone: "13800000003", role: "前台", status: "active", accountId: "u_frontdesk", hiredAt: "2025-04-01", baseSalary: 6000, commissionRate: 0.04 },
  ],
  customers: [
    {
      id: "c1",
  ...
  inventoryBatches: [],
  appointments: [
    { id: "a1", storeId: "store1", customerId: "c1", staffId: "s2", serviceId: "v1", startAt: tomorrowAt(10), roomName: "护理房 1", status: "已确认", note: "做完需回访" },
    { id: "a2", storeId: "store1", customerId: "c3", staffId: "s1", serviceId: "v3", startAt: tomorrowAt(14), roomName: "VIP护理房", status: "待确认", note: "老客套餐咨询" },
  ],
