...
为美业门店提供一套覆盖“客户到店、预约、开单、会员卡、服务消耗、员工提成、库存扣减、财务报表、营销增长、连锁管理”的经营管理系统。

第一版优先服务单店经营，后续扩展多门店连锁、抖音/美团核销、分销、拼团、秒杀、共享店铺等能力。

### 1.4 核心用户

| 角色 | 使用目标 |
| --- | --- |
| 老板/投资人 | 查看经营数据、收入利润、会员资产、员工绩效、多门店表现 |
| 店长/经理 | 管理预约、员工排班、订单审核、业绩分析、库存和营销 |
| 前台 | 预约登记、客户接待、开单收银、办卡续卡 |
| 美容师/理疗师 | 查看预约、服务客户、记录项目消耗、查看提成 |
| 财务 | 对账、查看收入、退款、欠款、储值余额、财务报表 |
| 客户/会员 | 在线预约、查看卡项、消费记录、领取优惠券 |
...
| 模块 | 功能 |
| --- | --- |
| 小程序/H5 | 客户在线预约、卡项查看、消费记录 |
| 消费推送 | 消费通知、预约提醒、余额提醒 |
| 优惠券 | 发券、领券、核销、过期 |
| 拼团秒杀 | 活动配置、下单、核销 |
| 电子展厅 | 项目介绍、门店环境、案例展示 |
| 会员营销 | 标签筛选、沉睡客户、生日提醒、活动触达 |

### 2.3 第三阶段

| 模块 | 功能 |
| --- | --- |
| 连锁管理 | 总部门店架构、多店数据汇总、跨店会员 |
| 共享店铺 | 联营门店、共享项目、结算分账 |
| 抖音核销 | 团购券导入/核销、订单映射 |
| 美团核销 | 套餐券核销、核销记录 |
| 分销 | 分销员、推广链接、佣金结算 |
| 营销策划 | 每年一次营销活动方案、活动日历 |
...
| 营销 | 拼团活动 | 拼团商品/项目 | 二期 |
| 营销 | 秒杀活动 | 限时抢购 | 二期 |
| 营销 | 会员触达 | 标签筛选和消息推送 | 二期 |
| 展厅 | 电子展厅 | 门店、项目、案例展示 | 二期 |
| 平台 | 抖音核销 | 抖音券码核销 | 三期 |
| 平台 | 美团核销 | 美团券码核销 | 三期 |
| 连锁 | 门店管理 | 多门店资料 | 三期 |
| 连锁 | 总部看板 | 多门店汇总 | 三期 |
...
| value | decimal | 面额或折扣 |
| min_spend | decimal | 最低消费 |
| start_at | timestamp | 开始时间 |
| end_at | timestamp | 结束时间 |
| status | varchar | active/inactive |

#### customer_coupons 客户优惠券表
...
| store_id | uuid | 门店 |
| name | varchar | 活动名称 |
| campaign_type | varchar | coupon/group_buy/seckill/distribution |
| config | jsonb | 活动配置 |
| start_at | timestamp | 开始时间 |
| end_at | timestamp | 结束时间 |
